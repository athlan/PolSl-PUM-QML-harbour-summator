...
OBJECTS       = obj/harbour-summator.o
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		harbour-summator.pro \
		harbour-summator.pro
QMAKE_TARGET  = harbour-summator
...
Makefile: harbour-summator.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/harbour-summator1.0.0 || mkdir -p obj/harbour-summator1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/harbour-summator1.0.0/ && $(COPY_FILE) --parents src/harbour-summator.cpp obj/harbour-summator1.0.0/ && (cd `dirname obj/harbour-summator1.0.0` && $(TAR) harbour-summator1.0.0.tar harbour-summator1.0.0 && $(COMPRESS) harbour-summator1.0.0.tar) && $(MOVE) `dirname obj/harbour-summator1.0.0`/harbour-summator1.0.0.tar.gz . && $(DEL_FILE) -r obj/harbour-summator1.0.0
...
obj/harbour-summator.o: src/harbour-summator.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/harbour-summator.o src/harbour-summator.cpp
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-summator || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-summator
	-$(INSTALL_DIR) /home/mersdk/PUM/harbour-summator/qml $(INSTALL_ROOT)/usr/share/harbour-summator/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-summator/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-summator/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/PUM/harbour-summator/harbour-summator.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-summator.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/PUM/harbour-summator/harbour-summator.png $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/harbour-summator.png
